...
class IsolatingHeperTest(unittest.TestCase):
    ...
    def test_outerRing(self):
        iso = IsolatingHelper()
        self.assertTrue( iso.coordCanBeAlwaysRemoved("a1") )
        self.assertTrue( iso.coordCanBeAlwaysRemoved("a4") )
        self.assertTrue( iso.coordCanBeAlwaysRemoved("b5") )
        self.assertTrue( iso.coordCanBeAlwaysRemoved("d7") )
        self.assertTrue( iso.coordCanBeAlwaysRemoved("g2") )
        self.assertTrue( iso.coordCanBeAlwaysRemoved("e1") )
        self.assertFalse( iso.coordCanBeAlwaysRemoved("b2") )
        self.assertFalse( iso.coordCanBeAlwaysRemoved("d5") )
        self.assertFalse( iso.coordCanBeAlwaysRemoved("f4") )

    def test_surroundings(self):
        iso = IsolatingHelper()
        surr = iso.getSurrounding("b2")
